...
!*****************************************************************************************
    ...
    REAL(8), DIMENSION(:), ALLOCATABLE :: c1_inf_seq, c2_inf_seq, c3_inf_seq
    REAL(8), DIMENSION(:), ALLOCATABLE :: c1_inf_ak, c2_inf_ak, c3_inf_ak
    real(8) :: del_c1_inf_ak, del_c2_inf_ak, del_c3_inf_ak
    integer :: ID_phase_atk
    real(8) :: tol_c1_atk, tol_c2_atk, tol_c3_atk
    
    INTEGER :: step_aitken_u, step_aitken_s
!*****************************************************************************************
  END MODULE accel
!*****************************************************************************************
